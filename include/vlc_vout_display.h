...
enum {
    ...
    /* timing event (JS, 11/15) */
    VOUT_DISPLAY_EVENT_TIMING,   /* what is this? const video_format_t *p_source */
};
...
#endif
static inline void vout_display_SendEventTiming(vout_display_t *vd, ULONGLONG time)
{
    vout_display_SendEvent(vd, VOUT_DISPLAY_EVENT_TIMING, time);
}
